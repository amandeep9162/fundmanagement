...
<!-- Mirrored from kodesolution.com/demo/nonprofit/charity/charityfund-html/v3.4/demo/index-mp-layout1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2017 02:28:17 GMT -->
<head>
...
<body class="has-side-panel side-panel-right fullwidth-page side-push-panel"><div class="body-overlay"></div>
      ...
      <div class="widget no-border">
        <nav>
          <ul class="nav nav-list">
            <li><a href="#">my sdese</a></li>
            <li><a href="#">Couses</a></li>
            <li><a class="tree-toggler nav-header">Mission<i class="fa fa-angle-down"></i></a>
      ...
      <div class="container pt-0 pb-0">
        <div class="row">
          <div class="col-xs-12 col-sm-4 col-md-5">
            <div class="widget no-border m-0">
              <a class="menuzord-brand xs-pull-center mb-15" href="javascript:void(0)"><img src="{{asset('images/logo-wide.png')}}" alt=""></a>
            </div>
          </div>
        ...
        <div class="container">
          <nav id="menuzord" class="menuzord orange bg-light">
            <ul class="menuzord-menu">
                ...
                <ul class="dropdown">
                  ...
                  <li><a href="#">Dark Layout</a>
                    <ul class="dropdown">
                      ...
                      <li><a href="index-dark-mp-layout4.html">Dark Multipage Layout4</a></li>                    <li><a href="index-dark-mp-layout5.html">Dark Multipage Layout5</a></li>
                    </ul>
                  </li>
              ...
              <li><a href="#">Events</a>
                <ul class="dropdown">
                  <li><a href="{{route('create.event')}}">ADD EVENT</a></li>
                  <li><a href="#">Header</a>
                    <ul class="dropdown">
            ...
            <ul class="pull-right hidden-sm hidden-xs">
              <li>
               <div id="side-panel-trigger" class="side-panel-trigger pull-right sm-pull-none mt-5"><a href="#"><p class="btn btn-colored btn-flat btn-theme-colored mt-15 " id="loginform"  >Login/Register</p></a></div>
...
<!-- Mirrored from kodesolution.com/demo/nonprofit/charity/charityfund-html/v3.4/demo/index-mp-layout1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2017 02:29:50 GMT -->
</html>
